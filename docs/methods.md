...
This follows the convention in McIntosh & Lobaugh (2004) and differs
from packages that use mean-centred deviation coding (e.g. `plscmd`
in Matlab), where the reference level is explicit.
...
Permutation p-values use the corrected formula from Phipson & Smyth
(2010):
...
**Reference:** Phipson B, Smyth GK (2010). Permutation P-values
